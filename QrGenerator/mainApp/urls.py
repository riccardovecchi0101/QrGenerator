...
urlpatterns = [
    ...
    path('qr/<int:project_id>/<int:qr_id>/redirect_to_site', views.redirect_to_site, name='real_site'),
    path('<int:project_id>/project_info', views.project_info, name='project_info')
]
